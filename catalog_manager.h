...
public:
	AttrInfo() {}
	AttrInfo(const std::string& _name, int _typeId, int _strLen, bool _isUnique, bool _isPrimaryKey, bool _hasIndex) : name(_name), typeId(_typeId), strLen(_strLen), isUnique(_isUnique), isPrimaryKey(_isPrimaryKey), hasIndex(_hasIndex) {}
