...
void Node::resetByBlock(const Block &blk) {
    ...
    std::vector<AttrVal>::iterator iter_K=K.begin();
...
void Node::appendK(const AttrVal &_k) { K.push_back(_k); }
...
AttrVal Node::getK(int i) { return K[i]; }
int Node::getP(int i) { return P[i]; }

void Node::insert(const AttrVal &k, int p, int i) {
...
void Node::remove(const AttrVal &k, int p, int i) {
    K.erase(K.begin()+i);
    P.erase(P.begin()+i);
}
...
int BPlusTree::_findLeaf(const AttrVal &k) {
...
void BPlusTree::_insertNewBlk(Block &blk1, const AttrVal &k, Block &blk2) {
...
void BPlusTree::_remove(Block blk, AttrVal k) {
    Node node(blk);
    int i;
...
int BPlusTree::find(const AttrVal &k) {
...
void BPlusTree::insert(const AttrVal &k, int p) {
    int i;
    int blkPos = _findLeaf(k);
...
void BPlusTree::remove(const AttrVal &k) {
    int blkPos = _findLeaf(k);
...
//std::vector<int> BPlusTree::findLeft(const AttrVal &k, bool (*cmp)(const AttrVal &a,const AttrVal &b)) {
std::vector<int> BPlusTree::findLeft(const AttrVal &k) {
    std::vector<int> rst;
...
//std::vector<int> BPlusTree::findRight(const AttrVal &k, bool (*cmp)(const AttrVal &a,const AttrVal &b)) {
std::vector<int> BPlusTree::findRight(const AttrVal &k) {
    std::vector<int> rst;
